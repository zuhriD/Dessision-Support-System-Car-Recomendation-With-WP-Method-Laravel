              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->kriteria->nm_kriteria }}</td> 
                        <td>{{ $data->valuebobot }}</td>
                        <td>
                          <a href="{{ route('bobot.edit', ['bobot' => $data->id_bobot]) }}" class="btn btn-warning" >
                            <i class="fa fa-edit mr-2"></i>
                            Edit
                        </a>
                            <form action="{{ route('bobot.destroy', ['bobot'=> $data->id_bobot]) }}" method="post" class="d-inline">
                                @csrf
                                @method('delete')
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('bobot.store') }}" method="post">
                ...
                <div class="form-group">
                    <label for="value_bobot">Value bobot</label>
                    <input type="text" name="value_bobot" id="value_bobot" class="form-control" placeholder="Value Bobot" aria-describedby="helpId">
                </div>
